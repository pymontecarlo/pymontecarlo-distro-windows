...
class _WindowsDistribution:
    ...
    def _create_embed(self, requirements):
        ...
        embed.add_script('pymontecarlo_gui.__main__', 'main', 'pymontecarlo', console=False)
...
def main():
    parser = argparse.ArgumentParser(description='Create windows distribution of pymontecarlo')
    ...
    parser.add_argument('-d', '--dist', default=dist_dir,
